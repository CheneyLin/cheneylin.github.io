...
| 支付 | 订单确认页 | 查看预览图并支付 | 需确认收件地址、最终价格 | 展现收件地址、定制内容预览图、最终价格 |
...
| SKU关联图集下发接口 | 下发指定SKU关联的图集，供天意编辑器展示定制商品可选图素材 | P0 | `api_02` |
...
| 功能 | 描述 | 优先级 | 标识 |
|------|------|--------|------|
| 天意编辑器 | 接受小芒SPU、SKU参数，实现指定定制商品定制流程，完成天意侧下单后跳转小芒订单确认页 | P0 | `ty_01` |
...
### 9.3 技术文档
- 后端接口：https://u0t1gqhnrt.feishu.cn/wiki/Llm3we3iWiBV91klOcrcRNmun6g
- 设计物料：https://mastergo.com/goto/Uak46G9M?page_id=M&file=197722129170153
